...
async function checkLogin(toRedirect){
    return await fetch("https://stacklimit-community-qna-platform.onrender.com/check_login",{
        method: "GET",
...
async function getAnswers(){
    ...
    const url = "https://stacklimit-community-qna-platform.onrender.com/question/ans?id=" + id;
    return await fetch(url,{
        ...
        jsonResponse["details"].forEach(element => {
            ...
            if(element["likers"].includes(useremail)){
                likeElement.setAttribute("src","https://stacklimit-community-qna-platform.onrender.com/images/black-like.png");
            }
            else{
                likeElement.setAttribute("src","https://stacklimit-community-qna-platform.onrender.com/images/white-like.png");
            }
            ...
            likeArea.addEventListener("click",async (e) => {
                let postURL = "https://stacklimit-community-qna-platform.onrender.com/question/ans/like?ansID=" + element["_id"];
                await fetch(postURL,{
                    method: "POST",
                    credentials: 'include',
                    headers: {
